  ...
  $.fn.extend({
    ...
    page: function (options) {
      ...
      return this.each(function () {
        ...
        var l = opts.leng;
        if (l > 1&&l < 10) {
          str1 = '<li><a onclick="all(1)" class="'+ opts.activeClass +'">1</a></li>';
          for (i = 2; i < l + 1; i++) {
            str += '<li><a onclick="all('+i+')">' + i + '</a></li>';
          }
        }else if(l > 9){
          str1 = '<li><a onclick="all(1)" class="'+ opts.activeClass +'">1</a></li>';
          for (i = 2; i < 10; i++) {
            str += '<li><a oncilck="all('+i+')">' + i + '</a></li>';
          }
        ...
        function fpageShow(){
          ...
          var str1 = '';
          for(i=0;i<9;i++){
            str1 += '<li><a onclick="all('+(pageStart+i)+')" class="">' + (pageStart+i) + '</a></li>'
          }
        ...
        function fpagePrv(prv){
          ...
          if(l>8){
            for(i=0;i<9;i++){
              str1 += '<li><a onclick="all('+(i+1)+')" class="">' + (i+1) + '</a></li>'
            }
          }else{
            for(i=0;i<l;i++){
              str1 += '<li><a onclick="all('+(i+1)+')" class="">' + (i+1) + '</a></li>'
        ...
        function fpageNext(next){
          ...
          if(l>8){
            for(i=l-8;i<l+1;i++){
              str1 += '<li><a onclick="all('+i+')" class="">' + i + '</a></li>'
            }
           obj.find('ul').html(str1);
