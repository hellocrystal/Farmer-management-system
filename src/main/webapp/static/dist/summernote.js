...
(function (factory) {
  ...
  var codable = renderer.create('<textarea class="note-codable" name="content"/>');
  var editable = renderer.create('<div class="note-editable panel-body" contentEditable="true" id="content"/>');
